                            ...
                            >
                                <li className="dashboard__menu--item-list-item">
                                    <Link to="/dashboard/create/product">
                                        <i className="fa-solid fa-plus"></i> TẠO SẢN PHẨM
                                    </Link>
                                </li>
                                <li className="dashboard__menu--item-list-item">
                            ...
                            >
                                <li className="dashboard__menu--item-list-item">
                                    <Link to="/dashboard/create/category">
                                        <i className="fa-solid fa-plus"></i> TẠO DANH MỤC
                                    </Link>
                                </li>
                                <li className="dashboard__menu--item-list-item">
                            ...
                            >
                                <li className="dashboard__menu--item-list-item">
                                    <Link to="/dashboard/create/notification">
                                        <i className="fa-solid fa-plus"></i> TẠO THÔNG BÁO
                                    </Link>
                                </li>
                                <li className="dashboard__menu--item-list-item">
